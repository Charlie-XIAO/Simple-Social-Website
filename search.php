<?php
    ...
    if (isset($_GET['find'])) {
        $find = $_GET['find'];
        $sql = "select * from users where name like '%$find%' || username like '%$find%' limit 30";
                    ...
                    <?php
                        ...
                        if (is_array($results)) {
                            ...
                            foreach ($results as $row) {
                                ...
                                echo $FRIEND_ROW['username'] . "<span style='color: black; font-weight: normal;'> ($FRIEND_ROW[name])</span>";
                                echo "</a>";
                                echo "</div>";
